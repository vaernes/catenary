...
const SHELL_INJECT_OP: u32 = (1 << 25); // SYS_VARDE_INJECT
const FB_GET_INFO_OP: u32 = (1 << 26); // SYS_FB_GET_INFO
...
pub fn allowedSyscallMask(kind: ServiceKind) u32 {
    return switch (kind) {
        ...
        .windowd => COMMON_OPS_LOW | FB_DRAW_OP | FB_DRAW_COLORED_OP | FB_FILL_RECT_OP | TRY_RECV_OP | KBD_OP | SHELL_HISTORY_OP | SHELL_INJECT_OP | FB_GET_INFO_OP,
